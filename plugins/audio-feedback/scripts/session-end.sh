...
#
# Note: hooks.json sets "background": true, so the hook runner already
# detaches this process. A secondary ( ... ) & would double-fork and
# orphan grandchild processes — run everything in the foreground here.
